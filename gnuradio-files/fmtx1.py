...
class fmtx1(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/home/owen/Documents/DAB-FM-HackRF-Transmit/pipes/stream1.fifo', True, 0, 0)

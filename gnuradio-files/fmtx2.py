...
class fmtx2(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/home/anyone/Documents/radio/DAB-FM-HackRF-Transmit/linux/pipes/stream2.fifo', True, 0, 0)
...
def main(top_block_cls=fmtx2, options=None):
    tb = top_block_cls()
